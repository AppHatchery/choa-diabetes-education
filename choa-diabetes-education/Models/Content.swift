...
class ContentChapter {
    ...
    let sectionOne = [
        Content(contentTitle: "What is Diabetes?", contentParent: "Diabetes Basics", contentHTML: "whatisdiabetes", quizQuestions:["Diabetes is best described as:"], quizAnswers: [["A. The body’s lack of insulin-producing beta cells","B. The body’s inability to regulate blood glucose with proper amounts of insulin","C. The body’s rejection of insulin by the pancreas","D. The body’s insulin response to carbohydrates"]],quizCorrectAnswer: [[1]]),
