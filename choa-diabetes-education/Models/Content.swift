...
class ContentChapter {
    ...
    let sectionOne = [
        Content(contentTitle: "What is Diabetes?", contentParent: "Diabetes Basics", contentHTML: "1_1_1_whatisdiabetes", contentSubheader: "Types of diabetes, signs and symptoms, and treatment", quizQuestions:["Diabetes is best described as:"], quizAnswers: [["The body’s lack of ability to produce insulin","Eating too much sugar","The body’s inability to regulate blood glucose with insulin resulting in high blood sugars"]], quizCorrectAnswer: [[0,2]]),
        Content(contentTitle: "Blood sugar monitoring", contentParent: "Diabetes Basics", contentHTML: "1_2_1_when_to_check_bg",contentSubheader: "When and how to check blood sugar", quizQuestions:["How often should BG be checked in Type 1 Diabetes?"], quizAnswers: [["Hourly","Every 5 minutes","Before meals, before bed, and before exercise","Fasting and 2 hours after largest meal"]],quizCorrectAnswer: [[2]]),
        Content(contentTitle: "Types of insulin", contentParent: "Diabetes Basics", contentHTML: "1_3_1_types_of_insulin", contentSubheader: "Types of insulin, storage, and where to give an injection", quizQuestions:["Long-acting insulin should be given:"], quizAnswers: [["Once a day","With every meal"," Weekly","Only at bedtime"]],quizCorrectAnswer: [[0]]),
        Content(contentTitle: "Insulin Administration", contentParent: "Diabetes Basics", contentHTML: "1_4_1_with_pen", contentSubheader: "Insulin injection technique and importance of site rotation", quizQuestions:["Insulin may be administered in each of the following areas: (check all that apply)"], quizAnswers: [["Stomach","Buttocks","Fingers","Legs"]],quizCorrectAnswer: [[0,1,3]]),
        Content(contentTitle: "Check for ketones", contentParent: "Diabetes Basics", contentHTML: "1_5_1_managing_ketones", contentSubheader: "Symptoms of hyperglycemia, when and how to check for ketones", quizQuestions:["Ketones indicate:"], quizAnswers: [["BG is well managed","Diabetes is out of balance","BG is high","There is enough insulin to carry glucose (sugar) into cells"]],quizCorrectAnswer: [[1]]),
    ]
