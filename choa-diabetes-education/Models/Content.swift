...
class ContentChapter {
    ...
    let sectionOne = [
        ...
        Content(contentTitle: "Types of insulin", contentParent: "Diabetes Basics", contentHTML: "insulin", contentSubheader: "Types of insulin, storage, and where to give an injection", quizQuestions:["Long-acting insulin should be given:"], quizAnswers: [["1-2 times daily","With every meal"," Weekly","Only at bedtime"]],quizCorrectAnswer: [[0]]),
        Content(contentTitle: "How to calculate insulin dosing", contentParent: "Diabetes Basics", contentHTML: "how_to_calculate_insulin_dosing", contentSubheader: "Long and rapid acting insulin; ways to calculate insulin for food and for blood sugar", quizQuestions:["Rapid-acting insulin may be calculated using:"], quizAnswers: [["Insulin to carbohydrate ratio","Correction factor","Set dosing","Sliding scale"]],quizCorrectAnswer: [[0,1,2,3]]),
        Content(contentTitle: "How to give insulin shot", contentParent: "Diabetes Basics", contentHTML: "how_to_give_insulin_shot", contentSubheader: "Insulin injection technique and importance of site rotation", quizQuestions:["Insulin may be given via: (check all that apply)"], quizAnswers: [["Intramuscular injection","Subcutaneous injection","Insulin pump","Central line"]],quizCorrectAnswer: [[1,2]]),
    ]
    ...
    let sectionTwo = [
        ...
        Content(contentTitle: "How to count carbs", contentParent: "Nutrition and Diabetes", contentHTML: "how_to_count_carbs", contentSubheader: "Importance of accurate carb counting and how to count carbs: nutrition fact labels and food lists", quizQuestions:["Placeholder Question"], quizAnswers: [["placeholder Answer"]],quizCorrectAnswer: [[0]]),
        Content(contentTitle: "Carb counting Apps", contentParent: "Nutrition and Diabetes", contentHTML: "cabs_counting_apps", contentSubheader: "Resources to help with carb counting on-the-go", quizQuestions:["Placeholder Question"], quizAnswers: [["Placeholder Answer"]],quizCorrectAnswer: [[0]]),
    ]

    let sectionThree = [
        Content(contentTitle: "Check for ketones", contentParent: "Diabetes Self-Management", contentHTML: "check_for_ketones", contentSubheader: "Symptoms of hyperglycemia, when and how to check for ketones", quizQuestions:["Ketones indicate:"], quizAnswers: [["BG is well managed","Diabetes is out of balance","BG is high","There is enough insulin to carry glucose (sugar) into cells"]],quizCorrectAnswer: [[1]]),
