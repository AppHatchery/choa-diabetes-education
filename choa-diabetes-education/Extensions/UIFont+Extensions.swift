...
extension UIFont {
    public static let nunitoBold16 = UIFont(name: "Nunito-Bold", size: 16.0)!
	public static let nunitoBold14 = UIFont(name: "Nunito-Bold", size: 14.0)!
	public static let nunitoBold32 = UIFont(name: "Nunito-Bold", size: 32.0)!
    ...
    public static let nunitoSemiBold = UIFont(name: "Nunito-SemiBold", size: 18.0)!
    ...
    public static let arial17 = UIFont(name: "Arial", size: 17)
    public static let arialMedium20 = UIFont(name: "Arial", size: 20.0)!
