...
class MultipleOptionsView: UIView {
    ...
    @IBAction func didNextButtonTap(_ sender: UIButton) {
        ...
        case MultipleOptionsDescriptionAtBottomQueId.urineKetones.id:
            delegate?.didSelectNextAction(currentQuestion: currentQuestion, selectedAnswer: MultipleOptionsAnswer.KetonesMeasurements(KetonesMeasurements(id: selected)))
            default:
                break
